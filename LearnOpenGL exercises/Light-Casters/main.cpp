...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		lightingShader.setVec3("dirLight.ambient", 0.25f, 0, 0);
		...
		lightingShader.setFloat("pointLights[0].quadratic", 0.2);
		// point light 2
		...
		lightingShader.setFloat("pointLights[1].quadratic", 0.2);
		// point light 3
		...
		lightingShader.setFloat("pointLights[3].quadratic", 0.2);
		// spotLight
		...
		lightingShader.setFloat("spotLight.linear", .35);
		lightingShader.setFloat("spotLight.quadratic", .44);
