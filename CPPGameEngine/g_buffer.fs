...
vec2 ParallaxMapping(vec2 texCoords, vec3 viewDir) {
    ...
    vec2 P = viewDir.xy / viewDir.z * .02; //heightScale hardcoded to a small value; 
    vec2 deltaTexCoords = P / numLayers;
  
    // get initial values
	// flip my y if your POM is inverted vertically; in my case, y must be flipped when applying any sort of UV map in 3ds max (which I almost always do)
...
void main() {
	...
	// uncomment me to discard texture coordinates outside the [0:1] range; creates nicer edges but causes black borders between perpendicular faces       
