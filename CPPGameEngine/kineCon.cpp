...
*/
btVector3 kineCon::computeReflectionDirection(const btVector3& direction, const btVector3& normal)
{
...
*/
btVector3 kineCon::parallelComponent(const btVector3& direction, const btVector3& normal)
{
...
*/
btVector3 kineCon::perpindicularComponent(const btVector3& direction, const btVector3& normal)
{
	return direction - parallelComponent(direction, normal);
}

kineCon::kineCon(btPairCachingGhostObject* ghostObject, btConvexShape* convexShape, btScalar stepHeight, const btVector3& up)
{
...
btPairCachingGhostObject* kineCon::getGhostObject()
{
	return m_ghostObject;
}

bool kineCon::recoverFromPenetration(btCollisionWorld* collisionWorld)
{
...
void kineCon::stepUp(btCollisionWorld* world)
{
...
bool kineCon::needsCollision(const btCollisionObject* body0, const btCollisionObject* body1)
{
...
void kineCon::updateTargetPositionBasedOnCollision(const btVector3& hitNormal, btScalar tangentMag, btScalar normalMag)
{
...
void kineCon::stepForwardAndStrafe(btCollisionWorld* collisionWorld, const btVector3& walkMove)
{
...
void kineCon::stepDown(btCollisionWorld* collisionWorld, btScalar dt)
{
...
void kineCon::setVelocityForTimeInterval(
...
void kineCon::setAngularVelocity(const btVector3& velocity)
{
	m_AngVel = velocity;
}

const btVector3& kineCon::getAngularVelocity() const
{
	return m_AngVel;
}

void kineCon::setLinearVelocity(const btVector3& velocity)
{
	m_walkDirection = velocity;
...
btVector3 kineCon::getLinearVelocity() const
{
	return m_walkDirection + (m_verticalVelocity * m_up);
}

void kineCon::reset(btCollisionWorld* collisionWorld)
{
	m_verticalVelocity = 0.0;
	m_verticalOffset = 0.0;
	m_wasOnGround = false;
...
void kineCon::warp(const btVector3& origin)
{
	btTransform xform;
	xform.setIdentity();
...
void kineCon::preStep(btCollisionWorld* collisionWorld)
{
	m_currentPosition = m_ghostObject->getWorldTransform().getOrigin();
	m_targetPosition = m_currentPosition;
...
void kineCon::playerStep(btCollisionWorld* collisionWorld, btScalar dt)
{
	//	printf("playerStep(): ");
	//	printf("  dt = %f", dt);
...
void kineCon::setFallSpeed(btScalar fallSpeed)
{
	m_fallSpeed = fallSpeed;
}

void kineCon::setJumpSpeed(btScalar jumpSpeed)
{
	m_jumpSpeed = jumpSpeed;
	m_SetjumpSpeed = m_jumpSpeed;
}

void kineCon::setMaxJumpHeight(btScalar maxJumpHeight)
{
	m_maxJumpHeight = maxJumpHeight;
}

bool kineCon::canJump() const
{
	return onGround();
}

void kineCon::jump(const btVector3& v)
{
...
void kineCon::setGravity(const btVector3& gravity)
{
...
btVector3 kineCon::getGravity() const
{
	return -m_gravity * m_up;
}

void kineCon::setMaxSlope(btScalar slopeRadians)
{
	m_maxSlopeRadians = slopeRadians;
	m_maxSlopeCosine = btCos(slopeRadians);
}

btScalar kineCon::getMaxSlope() const
{
	return m_maxSlopeRadians;
}

void kineCon::setMaxPenetrationDepth(btScalar d)
{
	m_maxPenetrationDepth = d;
}

btScalar kineCon::getMaxPenetrationDepth() const
{
	return m_maxPenetrationDepth;
}

bool kineCon::onGround() const
{
	return (fabs(m_verticalVelocity) < SIMD_EPSILON) && (fabs(m_verticalOffset) < SIMD_EPSILON);
}

void kineCon::setStepHeight(btScalar h)
{
	m_stepHeight = h;
}

btVector3* kineCon::getUpAxisDirections()
{
...
void kineCon::debugDraw(btIDebugDraw* debugDrawer)
{
}

void kineCon::setUpInterpolate(bool value)
{
	m_interpolateUp = value;
}

void kineCon::setUp(const btVector3& up)
{
...
void kineCon::setUpVector(const btVector3& up)
{
	if (m_up == up)
		return;
...
btQuaternion kineCon::getRotation(btVector3& v0, btVector3& v1) const
{
