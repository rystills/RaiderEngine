...
int main() {
	...
	TextObject* to1 = addTextObject(new TextObject("",6, UI_TARGET_HEIGHT - 44.f, Color::white, "Inter-Regular", 18));
	TextObject* to2 = addTextObject(new TextObject("", 6, UI_TARGET_HEIGHT - 68.f, Color::white, "Inter-Regular", 18));
