...
void ObjectRegistry::instantiateGameObject(std::string name, glm::vec3 pos, glm::vec3 rot, glm::vec3 scale, std::vector<std::string> extraArgs) {
	...
	else if (name == "Cog") addGameObject(new Cog(pos, rot, scale, stof(extraArgs[0]), std::stoi(extraArgs[1]), extraArgs.size() > 2 ? std::stoi(extraArgs[2]) : 1));
	else if (name == "FoliageGrass") addGameObject(new FoliageGrass(pos, rot, scale));
}

void ObjectRegistry::instantiateLight(std::string name, glm::vec3 pos, glm::vec3 rot, glm::vec3 scale, std::vector<std::string> extraArgs) {
